...
//        request.httpBody = jsonData
        Alamofire.request(pathurl, method: HTTPMethod(rawValue: httpMethod) ?? .post, parameters: Para, encoding: URLEncoding.default, headers: headers).responseJSON { response in
...
//            }
        }, to: pathurl, method: .post,headers: para) { (result) in
            switch result {
