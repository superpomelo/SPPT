...
public let Host = "http://111.74.0.246:8081/vrplatform/"

public let Hosturl = "http://111.74.0.246:8081/vrplatform/oss/object/v2-cloud"
...
public let seDiao_Color1  = UIColor.init(red: 36/255.0, green: 36/255.0, blue: 36/255.0, alpha: 1)
